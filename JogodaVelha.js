    ...
    for(let i =0;i<espacos.length;i++){
        espacos[i].addEventListener("click",function () {
                ...
                if(this.getElementsByTagName("img").length == 0){
                    if(playTime==player1){
                        this.innerHTML="<img class='jdv' src='imagens/600px-Red_x.svg.png'>";
                        this.setAttribute("jogada",player1);
                        playTime = player2;
                    }else{
                        this.innerHTML="<img class='jdv' src='imagens/bola.png'>";
...
function atualizaMostrador() {
    ...
    if(playTime==player1){
        ...
        player.setAttribute("src","imagens/600px-Red_x.svg.png");
    }else{
        let player=document.querySelectorAll("div#mostrador img")[0];
